                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                                    ...
                                    <div class="flex flex-col p-4 leading-normal">
                                        ...
                                        <div class="absolute bottom-0 right-0 p-4 flex justify-between">
                                            ...
                                            <form action="{{ route('categories.destroy', $category) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="bg-red-500 hover:bg-red-700 text-white font-bold p-1 rounded w-full md:w-auto ms-2">
                                                    Eliminar
                                                </button>
                                            </form>
                                        </div>
                    ...
                    @else
                        <p class="mt-4 bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
                            ...
                            <span class="block sm:inline">No hay categorias de vinos creadas aún.</span>
                        </p>
                    @endif
                </div>
            </div>
